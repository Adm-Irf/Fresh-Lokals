...
const About = () => {
    return (
        <div className="about-page">
            ...
            {/* Featurette Section */}
            <section className="featurette-container">
                {/* Our Mission Featurette */}
            ...
            </section> {/* ✅ Properly closing featurette section here */}
